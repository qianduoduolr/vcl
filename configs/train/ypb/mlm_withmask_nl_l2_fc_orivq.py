import os
exp_name = 'mlm_withmask_nl_l2_fc_orivq'
...
train_pipeline = [
    ...
    dict(type='Collect', keys=['imgs', 'masks', 'mask_query_idx'], meta_keys=[]),
    dict(type='ToTensor', keys=['imgs', 'masks', 'mask_query_idx'])
]
...
data = dict(
    ...
    train=
            ...
            data_prefix=dict(RGB='train/JPEGImages', FLOW='train_all_frames/Flows_s256', ANNO='train/Annotations'),
            mask_ratio=0.15,
            clip_length=2,
            vq_size=32,
