...
exp_name = 'spa_temp_res18_d4_l2_cmp_t0.0_m_Res18t_d2_vae_learntp_self-training-s1'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Cmp',
    motion_estimator=dict(type='ResNet',depth=18, strides=(1, 1, 1, 1), out_indices=(2, ), pool_type='mean', pretrained='/gdata/lirui/expdir/VCL/group_stsl_former/dist_nl_l2_layer4_mast_d2/epoch_1600_revised_keys.pth', torchvision_pretrain=False),
    # motion_estimator=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/gdata/lirui/expdir/VCL/group_stsl_former/final_framework_v2_33/epoch_800.pth', torchvision_pretrain=False),
    ...
    loss_weight=dict(l1_loss=1, cmp_loss=0, vae_rec_loss=1, vae_kl_loss=0.000001, corr_loss=500),
    detach=True
)
