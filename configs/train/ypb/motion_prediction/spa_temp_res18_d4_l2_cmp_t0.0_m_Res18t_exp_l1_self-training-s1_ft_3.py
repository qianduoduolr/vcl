...
exp_name = 'spa_temp_res18_d4_l2_cmp_t0.0_m_Res18t_exp_l1_self-training-s1_ft_3'
...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 1), out_indices=(2, 3), pool_type='none', dilations=(1,1,2,4), pretrained='/gdata/lirui/expdir/VCL/group_stsl_former/mast_d4_l2_pyramid_dis_18/epoch_3200.pth', torchvision_pretrain=False),
    ...
    mode='exp',
    loss_weight=dict(l1_loss=1, corr_loss=0.01, cmp_loss=0.01),
    detach=True
)
