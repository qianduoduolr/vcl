...
exp_name = 'spa_temp_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_self-training-s1_ft_5'
...
model = dict(
    ...
    loss_weight=dict(stage0_l1_loss=1, stage1_l1_loss=1, cmp_loss=0, vae_rec_loss=0, vae_kl_loss=0, local_corr_dist_loss=1000, corr_loss=0),
    detach=True
)
