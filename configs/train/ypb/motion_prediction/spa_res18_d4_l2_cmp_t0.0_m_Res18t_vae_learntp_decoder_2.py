...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_decoder_2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Cmp_V2',
    decoder=dict(type='Decoder', in_c=256, mid_c=128, out_c=64, scale=2),
    ...
    loss_weight=dict(l1_loss=0, vae_rec_loss=1, vae_kl_loss=0.001, corr_loss=0),
    modality='RGB',
    detach=True,
    mp_only=True,
)
...
visual_config = dict(type='VisualizationHook_Custom', norm_mode='mean-std', res_name_list=['gt', 'rec'], interval=1000, output_dir='vis')
