...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_19'
...
model = dict(
    ...
    motion_estimator_s=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/gdata/lirui/expdir/VCL/group_motion_prediction/spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_12/epoch_160.pth', torchvision_pretrain=False),
    ...
    loss_weight=dict(l1_loss=0, cmp_loss=0, vae_rec_loss=1, vae_kl_loss=1, corr_loss=0),
    detach=True,
    mp_only=True
)
