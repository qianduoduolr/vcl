...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_m_Res50_vae_learntp_4'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Cmp',
    motion_estimator=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(2, ), pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
