...
exp_name = 'spa_temp_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_pyf'
...
model = dict(
    ...
    loss_weight=dict(stage0_l1_loss=1, stage1_l1_loss=1, vae_rec_loss=1, vae_kl_loss=0.001, local_corr_dist_loss=1000),
    detach=True
)
...
data = dict(
    workers_per_gpu=2,
    train_dataloader=dict(samples_per_gpu=20, drop_last=True),  # 4 gpus
