...
exp_name = 'spa_temp_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_self-training-s1'
...
model = dict(
    ...
    loss_weight=dict(l1_loss=1, cmp_loss=0, vae_rec_loss=1, vae_kl_loss=0.000005, corr_loss=0.05),
    detach=True
)
