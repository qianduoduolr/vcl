...
exp_name = 'temp_res18_d4_l2_cmp_t0.0_m_Res50_exp_m_l1_t3'
...
model = dict(
    ...
    pretrained='/gdata/lirui/expdir/VCL/group_motion_prediction/spa_res18_d4_l2_cmp_t0.0_m_Res50_exp_l1_t3/epoch_320.pth',
    detach=True
)
