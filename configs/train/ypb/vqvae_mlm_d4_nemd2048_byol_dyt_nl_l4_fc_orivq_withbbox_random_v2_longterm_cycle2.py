...
exp_name = 'vqvae_mlm_d4_nemd2048_byol_dyt_nl_l4_fc_orivq_withbbox_random_v2_longterm_cycle2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Vqvae_Tracker_V11',
...
optimizers = dict(
    ...
    fc=dict(type='Adam', lr=0.0001, betas=(0.9, 0.999))
    )
# learning policy
# total_iters = 200000
runner_type='epoch'
