...
exp_name = 'mae_vit_b_d4_eval'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='VisionTransformer', arch='b', img_size=(224, 224), patch_size=16, out_indices=(11,)),
    backbone_t=None,
...
test_cfg = dict(
    ...
    topk=5,
    temperature=0.1,
    model_cfg=dict(img_size=(224, 224),patch_size=16, arch='b', out_indices=(11,)),
    neighbor_range=24,
    with_first=True,
...
eval_config= dict(
                  ...
                  torchvision_pretrained='/gdata/lirui/models/ssl/image_based/mae_pretrain_vit_base.pth'
                )
