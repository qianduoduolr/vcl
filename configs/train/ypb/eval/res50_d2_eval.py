...
exp_name = 'res50_d2_eval_3'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(1,), pool_type='none'),
    backbone_t=None,
...
log_level = 'INFO'
work_dir = f'/gdata/lirui/expdir/VCL/group_stsl/evaluation/{exp_name}'
...
eval_config= dict(
                  ...
                  checkpoint_path='/gdata/lirui/expdir/VCL/group_stsl_former/final_framework_v2_33/epoch_800.pth',
