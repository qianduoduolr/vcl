...
exp_name = 'simmim_swin_ba_d4_eval_2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='SwinTransformer', pretrain_img_size=(192, 192), embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), strides=(4, 2, 1, 1), window_size=6),
    backbone_t=None,
...
test_cfg = dict(
    ...
    topk=10,
    temperature=0.07,
    model_cfg=dict(pretrain_img_size=(192, 192), strides=(4, 2, 1, 1), window_size=6, out_indices=(3,)),
    neighbor_range=24,
    with_first=True,
...
eval_config= dict(
                ...
                #   checkpoint_path=f'/gdata/lirui/expdir/VCL/group_stsl/{exp_name}/epoch_{max_epoch}.pth',
                  ...
                  torchvision_pretrained='/gdata/lirui/models/ssl/image_based/simmim_pretrain__swin_base__img192_window6__800ep.pth'
                )
...
if __name__ == '__main__':
    ...
    make_local_config(exp_name, file='stsl/vit_based')