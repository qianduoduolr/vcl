...
exp_name = 'dino_deit_sma_d4_eval_3'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='VisionTransformer', arch='deit-s', img_size=(224, 224), patch_size=8, out_indices=(12,)),
    backbone_t=None,
...
eval_config= dict(
                  ...
                  torchvision_pretrained='/gdata/lirui/models/ssl/image_based/dino_deitsmall8_pretrain.pth'
                )
