...
exp_name = 'raft_d4_eval'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='MotionBasicEncoder', out_indices=-1,  pretrained='/gdata/lirui/models/optical_flow/raft-things.pth', output_dim=256, norm_fn='instance'),
    backbone_t=None,
