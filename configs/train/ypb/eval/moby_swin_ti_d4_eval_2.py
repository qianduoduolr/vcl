...
exp_name = 'moby_swin_ti_d4_eval_2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='SwinTransformer', pretrain_img_size=(224, 224), strides=(4, 2, 1, 1), out_indices=(3,)),
    backbone_t=None,
...
test_cfg = dict(
    ...
    topk=10,
    temperature=0.07,
    model_cfg=dict(pretrain_img_size=(224, 224),strides=(4, 2, 1, 1), out_indices=(3,)),
    neighbor_range=24,
    with_first=True,
...
eval_config= dict(
                  ...
                  torchvision_pretrained='/gdata/lirui/models/ssl/image_based/moby_swin_t_300ep_pretrained.pth'
                )
