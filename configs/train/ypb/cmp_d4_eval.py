...
exp_name = 'cmp_d4_eval'
docker_name = 'bit:5000/lirui_torch1.5_cuda10.1_corr'

# model settings
model = dict(
    type='Vqvae_Tracker_V16',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(3, ), dilations=(1, 1, 2, 4)),
...
eval_config= dict(
                ...
                #   checkpoint_path=f'/gdata/lirui/expdir/VCL/group_vqvae_tracker/{exp_name}/epoch_{max_epoch}.pth'
                  ...
                  torchvision_pretrained='/gdata/lirui/models/cmp_res50_revise_keys.pth'
                )
