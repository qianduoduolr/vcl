...
exp_name = 'dist_nl_l2_layer4_mast_11'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=18, strides=(1, 2, 1, 2), out_indices=(3, ),pretrained='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd2048_contrastive_byol_commit1.0_v2_12/epoch_3200_revise_keys.pth', torchvision_pretrain=False),
