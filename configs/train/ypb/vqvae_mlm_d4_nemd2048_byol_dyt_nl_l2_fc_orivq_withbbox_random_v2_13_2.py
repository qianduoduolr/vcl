...
exp_name = 'vqvae_mlm_d4_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_13_2'
...
model = dict(
    ...
    fc=True,
    temperature=1.0,
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd2048_contrastive_byol_commit0.5_v2/epoch_3200.pth',
)
