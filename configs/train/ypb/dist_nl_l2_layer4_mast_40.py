...
exp_name = 'dist_nl_l2_layer4_mast_40'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Dist_Tracker_V2',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(2, 3), pool_type='mean',pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
    ...
    loss=dict(type='MSELoss',reduction='mean', loss_weight=0),
    l1_loss=True,
    temperature=1.0,
    temperature_t=0.07,
    momentum=-1,
