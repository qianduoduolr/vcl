...
exp_name = 'mast_d4_l2_pyramid_dis_12'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=18, strides=(1, 1, 1, 1), out_indices=(2,), pool_type='mean', pretrained='/gdata/lirui/models/mast_d2_l2_base.pth', torchvision_pretrain=False),
