...
exp_name = 'dist_nl_l2_layer4_mast_21'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Dist_Tracker_Pyramiad',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 1, 2), out_indices=(2, 3), pool_type='mean'),
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(2, 3, ),pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
    loss=dict(type='MSELoss',reduction='mean', loss_weight=500),
    l1_loss=True,
    temperature=1.0,
    momentum=-1,
    mask_radius=6,
    pretrained='/gdata/lirui/expdir/VCL/group_vqvae_tracker/mast_d4_l2_base_area0.2/epoch_1600.pth'
)
