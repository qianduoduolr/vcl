...
exp_name = 'dist_nl_l2_layer4_mast_35'
...
model = dict(
    ...
    momentum=-1,
    mask_radius=6,
    pretrained='/gdata/lirui/expdir/VCL/group_vqvae_tracker/vqvae_mlm_d4_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_mast_14/epoch_1600.pth'
)
