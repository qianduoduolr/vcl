...
exp_name = 'mast_d4_l2_pyramid_eval'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Pyramid',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 1, 1), out_indices=(0, 2), pool_type='mean'),
)
...
eval_config= dict(
                  ...
                  checkpoint_path=f'/gdata/lirui/expdir/VCL/group_vqvae_tracker/mast_d4_l2_pyramid/epoch_{max_epoch}.pth',
                  out_indices=(0,),
                )
