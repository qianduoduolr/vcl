...
exp_name = 'mast_d4_l2_base_cos_3'
...
model = dict(
    ...
    downsample_rate=8,
    cos_loss=dict(type='ConcentrationSwitchLoss', win_len=8, stride=8, F_size=(32, 2, 32, 32), temp=1, loss_weight=10),
    radius=6,
    feat_size=32,
)
...
# visual_config = None
visual_config = dict(
    type='VisualizationHook_Custom', interval=1000, res_name_list=['imgs', 'err'], output_dir='vis'
)
