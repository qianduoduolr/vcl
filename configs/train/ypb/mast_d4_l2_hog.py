...
train_pipeline = [
    dict(type='RandomResizedCrop', area_range=(0.7,1.0), aspect_ratio_range=(1.5, 2.0),),
    dict(type='Resize', scale=(256, 256), keep_ratio=False),
    dict(type='Flip', flip_ratio=0.5),
    dict(type='RGB2LAB', output_keys='images_lab'),
    dict(type='RGB2GRAY', output_keys='images_gray'), 
    dict(type='Normalize', **img_norm_cfg_lab, keys='images_lab'),
    # dict(type='FormatShape', input_format='NPTCHW', keys='images_gray'),
    dict(type='FormatShape', input_format='NPTCHW', keys='images_lab'),
    dict(type='Collect', keys=['images_gray', 'images_lab'], meta_keys=[]),
    dict(type='ToTensor', keys=['images_gray', 'images_lab'])
]
