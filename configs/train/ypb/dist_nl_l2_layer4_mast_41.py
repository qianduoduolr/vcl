...
exp_name = 'dist_nl_l2_layer4_mast_41'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Dist_Tracker_V2',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 1, 2), out_indices=(2, 3), pool_type='mean', pretrained='/gdata/lirui/models/ssl/image_based/mocov2plus_400ep_imagenet100_res18_pretrain_revise_keys.pth'),
