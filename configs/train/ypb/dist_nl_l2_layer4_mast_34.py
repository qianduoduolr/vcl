...
exp_name = 'dist_nl_l2_layer4_mast_34'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(2, ),pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
