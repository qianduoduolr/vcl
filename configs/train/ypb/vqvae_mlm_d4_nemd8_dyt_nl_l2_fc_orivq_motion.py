...
model = dict(
    ...
    vqvae=dict(type='VQVAE', downsample=4, n_embed=8, channel=256, n_res_channel=128, embed_dim=128),
    ce_loss=dict(type='Ce_Loss',reduction='none'),
    patch_size=-1,
    fc=True,
    temperature=1.0,
    pretrained_vq='/gdata/lirui/models/vqvae/vqvae_youtube_d4_n8_c256_embc128.pth',
    pretrained=None
)
