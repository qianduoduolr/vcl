...
exp_name = 'vqvae_mlm_d4_nemd32_byol_dyt_nl_l2_fc_orivq_withbbox_random_mse_v2_2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Vqvae_Tracker_V4',
    ...
    vqvae=[dict(type='VQCL_v2', backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(3, )),
          ...
          dict(type='VQVAE_V2', downsample=4, n_embed=2048, channel=256, n_res_channel=128, embed_dim=128)],
