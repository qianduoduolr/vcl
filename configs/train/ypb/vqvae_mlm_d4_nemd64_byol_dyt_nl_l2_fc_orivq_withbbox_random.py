...
exp_name = 'vqvae_mlm_d4_nemd64_byol_dyt_nl_l2_fc_orivq_withbbox_random'
...
model = dict(
    ...
    vqvae=dict(type='VQCL_v2', backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(3, )),
               ...
               n_embed=64, commitment_cost=1.0,),
    ce_loss=dict(type='Ce_Loss',reduction='none'),
    patch_size=-1,
    fc=True,
    temperature=1.0,
    pretrained_vq='/gdata/lirui/models/vqvae/vqvae_youtube_d4_n64_c256_embc128_byol_commit1.0.pth',
    pretrained=None
)
