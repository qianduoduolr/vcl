...
exp_name = 'vqvae_mlm_d4_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_40'
...
model = dict(
    ...
    vqvae=dict(type='VQCL_v7', backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(2, )),
               ...
               n_embed=4096, commitment_cost=1.0,),
    ...
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd4096_contrastive_byol_commit1.0_v2_3/epoch_3200.pth',
)
