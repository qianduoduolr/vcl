...
exp_name = 'train_vqvae_video_d4_nemd2048_contrastive_byol_commit0.0_v3_6'
docker_name = 'bit:5000/lirui_torch1.5_cuda10.1_corres'

# model settings
model = dict(
    type='VQCL_v6',
    backbone=dict(type='ResNet', depth=18, strides=(1, 2, 2, 2), out_indices=(2, 3, )),
    sim_siam_head=dict(
        type='SimSiamHead',
        in_channels=512,
...
data = dict(
    ...
    train=
            ...
            root='/dev/shm',
            list_path='/dev/shm/2018/train_all_frames',
