...
exp_name = 'temp_res18_d4_l2_rec_kinetics_ns1'
...
train_pipeline = [
    dict(type='PyAVInit'),
    dict(type='SampleFrames', clip_len=2, frame_interval=1, num_clips=1),
    dict(type='PyAVDecode', mode='efficient'),
...
data = dict(
    ...
    train=
            ...
            root='/gpub/Kinetics_raw_video',
            list_path='/gdata/lirui/dataset/Kinetics/Kinetics_raw_video',
...
checkpoint_config = dict(interval=max_epoch//4, save_optimizer=True, by_epoch=True)
...
evaluation = dict(output_dir=f'{work_dir}/eval_output_val', interval=max_epoch//4, by_epoch=True
                  )
