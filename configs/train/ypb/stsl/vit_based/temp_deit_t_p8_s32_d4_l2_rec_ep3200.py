...
exp_name = 'temp_deit_t_p8_s32_d4_l2_rec_ep3200'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='VisionTransformer', arch='deit-t', img_size=256, patch_size=8, output_cls_token=False),
    backbone_t=None,
...
model_test = dict(
    type='VanillaTracker',
    backbone=dict(type='VisionTransformer', arch='deit-t', img_size=(480, 856), patch_size=8, output_cls_token=False),
)
