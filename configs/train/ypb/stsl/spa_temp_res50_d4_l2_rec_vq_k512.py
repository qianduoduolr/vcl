...
exp_name = 'spa_temp_res50_d4_l2_rec_vq_k512'
...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2,), pool_type='none', pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
    ...
    loss_weight=dict(l1_loss=1, s_loss=1000, diff_loss=1),
    downsample_rate=[8,],
    radius=[6,],
    temperature=1,
    feat_size=[32,],
