...
exp_name = 'spa_temp_res50_d4_l2_rec_pyramid_local_dist_t0.7_ucf2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(1, 2, 3), pool_type='none', pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
...
# dataset settings
train_dataset_type = 'UCF_dataset_rgb'
...
data = dict(
    ...
    train=
            ...
            root='/gdata2/lirui/dataset/UCF-101/UCF-101-lmdb240',
            list_path='/gdata2/lirui/dataset/UCF-101',
