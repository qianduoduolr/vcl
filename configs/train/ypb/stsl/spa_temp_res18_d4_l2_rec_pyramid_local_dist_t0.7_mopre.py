...
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 4), out_indices=(1, 2, 3), pool_type='none'),
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(3,), pool_type='none', dilations=(1,1,2,4), pretrained='/gdata/lirui//expdir/VCL/group_motion_prediction/spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_12/epoch_160.pth', torchvision_pretrain=False),
