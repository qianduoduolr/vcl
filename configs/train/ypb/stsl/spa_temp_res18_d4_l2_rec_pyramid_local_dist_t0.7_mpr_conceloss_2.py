...
exp_name = 'spa_temp_res18_d4_l2_rec_pyramid_local_dist_t0.7_mpr_conceloss_2'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(2,), pool_type='none', dilations=(1,1,2,4), pretrained='/gdata/lirui/expdir/VCL/group_motion_prediction/spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_12/epoch_160.pth', torchvision_pretrain=False),
    ...
    momentum=-1,
    detach=True,
    loss_weight = dict(stage0_l1_loss=1, stage1_l1_loss=1, layer_dist_loss=1000, correlation_dist_loss=0, conce_loss=10),
    pretrained=None
)
...
evaluation = dict(output_dir=f'{work_dir}/eval_output_val', interval=max_epoch//3, by_epoch=True
                  )
