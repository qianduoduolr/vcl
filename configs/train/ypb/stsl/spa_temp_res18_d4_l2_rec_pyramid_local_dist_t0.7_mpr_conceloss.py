...
exp_name = 'spa_temp_res18_d4_l2_rec_pyramid_local_dist_t0.7_mpr_conceloss'
...
model = dict(
    ...
    momentum=-1,
    detach=True,
    loss_weight = dict(stage0_l1_loss=1, stage1_l1_loss=1, layer_dist_loss=1000, correlation_dist_loss=0, conce_loss=1),
    pretrained=None
)
