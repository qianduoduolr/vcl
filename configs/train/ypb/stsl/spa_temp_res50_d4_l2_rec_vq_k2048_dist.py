...
exp_name = 'spa_temp_res50_d4_l2_rec_vq_k2048_dist'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
# model settings
model = dict(
    type='Memory_Tracker_Custom_Vq',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(2,),pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
    backbone_t=dict(type='ResNet',depth=18, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/gdata/lirui/expdir/VCL/group_stsl_former/mast_d4_l2_pyramid_dis_18/epoch_3200.pth', torchvision_pretrain=False),
    head=dict(type='MlpHead', head_in=1024, head_out=256, use_norm=True),
    vq=dict(type='VQ', channel=256, embed_dim=256, n_embed=2048),
    loss_weight=dict(t_loss=1000, s_loss=1000, diff_loss=1),
    downsample_rate=[8,],
    radius=[6,],
    temperature=1,
    feat_size=[32,],
