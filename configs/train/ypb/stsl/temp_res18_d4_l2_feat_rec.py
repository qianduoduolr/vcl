...
exp_name = 'temp_res18_d4_l2_feat_rec'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
# model settings
model = dict(
    type='Memory_Tracker_Custom_Feat_Rec',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 4), out_indices=(2,), pool_type='none'),
    backbone_f=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(2,),pretrained='/gdata/lirui/models/ssl/image_based/detco_200ep_AA.pth'),
    loss_weight=dict(ft_rec_loss=1),
    downsample_rate=[8,],
    radius=[6,],
    temperature=1,
    feat_size=[32,],
