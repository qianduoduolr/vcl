...
eval_config= dict(
                  ...
                  checkpoint_path=f'/gdata2/lirui/expdir/VCL/group_vqvae_tracker/vqvae_mlm_d4_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_mast_12_2/epoch_{max_epoch}.pth'
                )
