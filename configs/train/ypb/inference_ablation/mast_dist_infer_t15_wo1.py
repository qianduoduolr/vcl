...
exp_name = 'mast_dist_infer_t15_wo1'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Dist_Tracker_Pyramid_Raft',
    ...
    loss_weight=dict(att_0_loss=200, att_1_loss=100),
    l1_loss=True,
    temperature=1.0,
    temperature_t=0.07,
    momentum=-1,
...
eval_config= dict(
                  ...
                  checkpoint_path=f'/gdata/lirui/expdir/VCL/group_vqvae_tracker/dist_nl_l2_layer4_mast_32/epoch_{max_epoch}.pth',
                )
