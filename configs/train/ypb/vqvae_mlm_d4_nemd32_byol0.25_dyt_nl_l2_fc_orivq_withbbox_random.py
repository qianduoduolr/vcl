...
exp_name = 'vqvae_mlm_d4_nemd32_byol0.25_dyt_nl_l2_fc_orivq_withbbox_random'
...
model = dict(
    ...
    fc=True,
    temperature=1.0,
    pretrained_vq='/gdata/lirui/models/vqvae/vqvae_youtube_d4_n32_c256_embc128_byol_commit0.25.pth',
    pretrained=None
)
