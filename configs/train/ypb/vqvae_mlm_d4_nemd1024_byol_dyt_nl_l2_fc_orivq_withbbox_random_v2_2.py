...
exp_name = 'vqvae_mlm_d4_nemd1024_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_2'
...
model = dict(
    ...
    temperature=1.0,
    mask_radius=4,
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd1024_contrastive_byol_commit1.0_v2/epoch_3200.pth',
)
