...
exp_name = 'vqvae_mlm_d4_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_14_3'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Vqvae_Tracker_V13',
...
train_pipeline = [
    ...
    dict(type='Collect', keys=['imgs', 'jitter_imgs', 'mask_query_idx', 'frames_mask'], meta_keys=[]),
    dict(type='ToTensor', keys=['imgs', 'jitter_imgs', 'mask_query_idx', 'frames_mask'])
]
