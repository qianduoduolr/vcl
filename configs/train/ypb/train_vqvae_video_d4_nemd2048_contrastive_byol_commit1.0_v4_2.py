...
exp_name = 'train_vqvae_video_d4_nemd2048_contrastive_byol_commit1.0_v4_2'
docker_name = 'bit:5000/lirui_torch1.5_cuda10.1_corres'

# model settings
model = dict(
    type='VQCL_v10',
    backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(2, 3, ), pretrained='/gdata/lirui/models/ssl/vcl/vfs_pretrain/r18_nc_sgd_cos_100e_r2_1xNx8_k400-db1a4c0d.pth'),
    sim_siam_head=dict(
        type='SimSiamHead',
        in_channels=512,
