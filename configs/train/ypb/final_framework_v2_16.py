...
exp_name = 'final_framework_v2_16'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 2), out_indices=(1, 2, 3), dilations=(1,1,1,2),pool_type='none', pretrained='/gdata/lirui/models/ssl/image_based/moco_v2_res18_ep200_lab.pth'),
