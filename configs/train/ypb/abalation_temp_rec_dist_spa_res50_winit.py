...
exp_name = 'abalation_temp_rec_dist_spa_res50_winit'
...
data = dict(
    workers_per_gpu=2,
    train_dataloader=dict(samples_per_gpu=25, drop_last=True),  # 4 gpus
    ...
    train=
            ...
            list_path='/gdata/lirui/dataset/YouTube-VOS/2018/valid',
            data_prefix=dict(RGB='valid/JPEGImages_s256', FLOW='train_all_frames/Flows_s256', ANNO='train/Annotations'),
            clip_length=2,
            pipeline=train_pipeline,
            split='valid',
            test_mode=False),
            ...
            type=train_dataset_type,
            root='/gdata/lirui/dataset/YouTube-VOS',
            list_path='/gdata/lirui/dataset/YouTube-VOS/2018/test',
            data_prefix=dict(RGB='test/JPEGImages_s256', FLOW='train_all_frames/Flows_s256', ANNO='train/Annotations'),
            clip_length=2,
            pipeline=train_pipeline,
            split='test',
            test_mode=False),
