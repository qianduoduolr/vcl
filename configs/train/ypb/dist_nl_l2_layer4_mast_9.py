...
exp_name = 'dist_nl_l2_layer4_mast_9'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(3, ), pretrained='/gdata/lirui/models/vcl/r50_sgd_cos_100e_r5_1xNx2_k400-b7fb2a38_revise_key.pth', torchvision_pretrain=False),
    loss=dict(type='MSELoss',reduction='mean', loss_weight=100),
    l1_loss=True,
    temperature=1.0,
    momentum=-1,
    mask_radius=6,
