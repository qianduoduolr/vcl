...
exp_name = 'vqvae_mlm_d4_nemd2048_warp_dyt_nl_l2_fc_orivq_withbbox_random_3'
...
model = dict(
    ...
    fc=True,
    temperature=1.0,
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd2048_warp/epoch_800.pth',
    pretrained=None
)
