...
exp_name = 'vqvae_mlm_d4_nemd32_byol_nc_dyt_nl_l2_fc_orivq_withbbox_random'
...
model = dict(
    ...
    fc=True,
    temperature=0.1,
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd32_contrastive_byol_commit1.0_2/epoch_12800.pth',
    pretrained=None
)
