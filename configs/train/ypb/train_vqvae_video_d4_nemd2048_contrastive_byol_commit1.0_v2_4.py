...
exp_name = 'train_vqvae_video_d4_nemd2048_contrastive_byol_commit1.0_v2_4'
docker_name = 'bit:5000/lirui_torch1.5_cuda10.1_corres'

# model settings
model = dict(
    type='VQCL_v7',
    backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(2, 3), planes_custom=(64,128,128,512)),
    sim_siam_head=dict(
        type='SimSiamHead',
        in_channels=512,
