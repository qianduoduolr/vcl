...
exp_name = 'vqvae_mlm_d2_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_mast_3'
...
model = dict(
    ...
    vqvae=dict(type='VQCL_v2', backbone=dict(type='ResNet', depth=18, strides=(1, 1, 1, 1), out_indices=(3, ), dilations=(1, 1, 1, 2)),
    ...
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d2_nemd2048_contrastive_byol_commit1.0_v2_4/epoch_3200.pth',
)
...
load_from = None
resume_from = '/gdata/lirui/expdir/VCL/group_vqvae_tracker/vqvae_mlm_d2_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_mast_3/epoch_1600.pth'
workflow = [('train', 1)]
