...
exp_name = 'vqvae_mlm_d2_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Vqvae_Tracker_V15',
    ...
    pretrained_vq='/gdata/lirui/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d2_nemd2048_contrastive_byol_commit1.0_v2/epoch_3200.pth',
)
