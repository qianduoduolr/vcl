...
exp_name = 'vqvae_mlm_d4_nemd32-32_byol_dyt_nl_l2_fc_orivq_withbbox_random_0.5'
...
model = dict(
    ...
    vqvae=[dict(type='VQCL_v2', backbone=dict(type='ResNet', depth=18, strides=(1, 2, 1, 1), out_indices=(3, )),
            ...
            dict(type='VQVAE', downsample=4, n_embed=32, channel=256, n_res_channel=128, embed_dim=128)],
    ce_loss=dict(type='Ce_Loss',reduction='none'),
    multi_head_weight=[1.0,1.0],
    patch_size=-1,
    fc=True,
    temperature=0.1,
    pretrained_vq=['/gdata/lirui/models/vqvae/vqvae_youtube_d4_n32_c256_embc128_byol_commit1.0.pth',
                    '/gdata/lirui/models/vqvae/vqvae_youtube_d4_n32_c256_embc128_withbbox.pth'],
    pretrained=None
)
