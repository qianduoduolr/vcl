...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=18, strides=(1, 1, 1, 1), out_indices=(2,), pool_type='mean', pretrained='/home/lr/models/mast_d2_l2_base.pth', torchvision_pretrain=False),
