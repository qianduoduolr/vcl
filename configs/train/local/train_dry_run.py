...
exp_name_old = 'vqvae_mlm_d4_nemd32_byol_dyt_nl_l2_fc_orivq_withbbox'
...
eval_config= dict(
                  ...
                  checkpoint_path=f'/home/lr/expdir/VCL/group_vqvae_tracker/{exp_name_old}/epoch_{max_epoch}.pth'
                )
