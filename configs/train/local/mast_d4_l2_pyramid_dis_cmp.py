...
exp_name = 'mast_d4_l2_pyramid_dis_cmp'
...
model = dict(
    ...
    downsample_rate=[4,8],
    feat_size=[64,32],
    cmp_loss=dict(type='L1Loss',reduction='mean', loss_weight=0.1),
    detach=True,
    mode='l1_loss'
)
...
# visual_config = None
visual_config = dict(
    type='VisualizationHook_Custom', interval=100, res_name_list=['mask', 'imgs'], output_dir='vis_'
)
