...
exp_name = 'dist_nl_l2_layer4_mast_ewc'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Dist_Tracker_EWC',
    ...
    ewc=dict(type='EWC', 
             model=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(2, 3), pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
             model_old=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(3, ),pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
             ),
    l1_loss=True,
    temperature=1.0,
    temperature_t=0.07,
