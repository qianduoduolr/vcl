...
data = dict(
    ...
    train=
            ...
            data_prefix=dict(RGB='train_all_frames/JPEGImages_s256', FLOW='train_all_frames/Flows_s256', ANNO='train_all_frames/Annotations'),
            clip_length=5,
            step=8,
...
# optimizer
optimizers = dict(
    type='Adam', lr=0.0005, betas=(0.9, 0.999)
    )
