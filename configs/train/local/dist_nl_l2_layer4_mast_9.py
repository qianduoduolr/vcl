...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 2), out_indices=(3, ), pretrained='/home/lr/models/vcl/r50_sgd_cos_100e_r5_1xNx2_k400-b7fb2a38_revise_key.pth', torchvision_pretrain=False),
