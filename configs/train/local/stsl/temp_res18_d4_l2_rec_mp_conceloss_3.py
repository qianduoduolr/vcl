...
exp_name = 'temp_res18_d4_l2_rec_mp_conceloss_3'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 4), out_indices=(2,), dilations=(1,1,2,4), pretrained='/home/lr/models/ssl/image_based/cmp_res50_revise_keys.pth'),
