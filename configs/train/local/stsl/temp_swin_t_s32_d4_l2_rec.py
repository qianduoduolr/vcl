...
model = dict(
    ...
    backbone=dict(type='SwinTransformer_Mmcv', pretrain_img_size=256, strides=(4, 2, 2, 1), out_indices=(2,)),
    loss_weight=dict(l1_loss=1),
    downsample_rate=[16,],
    radius=[3,],
    feat_size=[16,],
    rec_sampling='centered',
    pretrained=None,
)

model_test = dict(
    type='VanillaTracker',
    backbone=dict(type='SwinTransformer', pretrain_img_size=(480, 856), strides=(4, 2, 2, 1), out_indices=(2,)),
)
