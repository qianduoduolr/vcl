...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(2,),pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
    backbone_t=dict(type='ResNet',depth=18, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/home/lr/expdir/VCL/group_stsl_former/mast_d4_l2_pyramid_dis_18/epoch_3200.pth', torchvision_pretrain=False),
