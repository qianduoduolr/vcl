...
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 4), out_indices=(1, 2, 3), pool_type='none', pretrained='/home/lr/models/ssl/image_based/moco_v2_res18_ep200_lab.pth'),
