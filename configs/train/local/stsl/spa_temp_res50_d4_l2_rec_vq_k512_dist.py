...
exp_name = 'spa_temp_res50_d4_l2_rec_vq_k512_dist'
...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2,), pool_type='none', pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
    # head=dict(type='MlpHead', head_in=1024, head_out=256, use_norm=True),
    head=dict(type='BasicBlock', inplanes=1024, planes=256),
    vq=dict(type='VQ', channel=256, embed_dim=256, n_embed=512),
    loss_weight=dict(l1_loss=1, s_loss=1000, diff_loss=0),
    downsample_rate=[8,],
    radius=[6,],
    temperature=1,
    feat_size=[32,],
