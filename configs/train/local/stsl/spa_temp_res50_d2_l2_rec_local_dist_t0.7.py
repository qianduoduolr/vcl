...
exp_name = 'spa_temp_res50_d2_l2_rec_local_dist_t0.7'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=50, strides=(1, 1, 1, 4), out_indices=(2, 3), pool_type='mean'),
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 1, 1, 4), out_indices=(3,),pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
    head=dict(type='MlpHead', head_in=1024, head_out=256),
