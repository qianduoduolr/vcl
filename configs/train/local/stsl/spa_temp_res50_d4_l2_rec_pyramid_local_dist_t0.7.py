...
exp_name = 'spa_temp_res50_d4_l2_rec_pyramid_local_dist_t0.7'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(1, 2, 3), pool_type='none', pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 2, 2), out_indices=(3,),pretrained='/home/lr/models/ssl/image_based/detco_200ep_AA.pth'),
