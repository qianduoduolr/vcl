...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_m_Res18t_exp_l1_flow'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Cmp_Flow',
...
train_pipeline = [
    ...
    dict(type='Normalize', **img_norm_cfg, keys='flows'),
    ...
    dict(type='FormatShape', input_format='NPTCHW', keys='flows'),

    dict(type='Collect', keys=['imgs', 'images_lab', 'flows'], meta_keys=[]),
    dict(type='ToTensor', keys=['imgs', 'images_lab', 'flows'])
]
