...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_soft'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Memory_Tracker_Custom_Pyramid_Cmp_V2',
    motion_estimator=dict(type='ResNet',depth=18, strides=(1, 1, 1, 1), out_indices=(2, ), pool_type='mean', pretrained='/home/lr/expdir/VCL/group_stsl_former/dist_nl_l2_layer4_mast_d2/epoch_1600.pth', torchvision_pretrain=False),
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='test', name=exp_name, config=model),log_artifact=False),
    ])
