...
exp_name = 'spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_20'
...
# model settings
model = dict(
    type='Memory_Tracker_Custom_Cmp_Fusion',
    ...
    motion_estimator_s=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2, ), dilations=(1,1,2,4), pool_type='none', pretrained='/home/lr/mount/expdir/VCL/group_motion_prediction/spa_res18_d4_l2_cmp_t0.0_m_Res18t_vae_learntp_12/epoch_160.pth', torchvision_pretrain=False),
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 2, 1), out_indices=(2, 3), pool_type='none', dilations=(1,1,2,4)),
