...
exp_name = 'vqvae_mlm_d4_nemd8_dyt_nl_l2_fc_orivq_motion'
...
model = dict(
    ...
    vqvae=dict(type='VQVAE', downsample=4, n_embed=8, channel=256, n_res_channel=128, embed_dim=128, newed=True),
    ce_loss=dict(type='Ce_Loss',reduction='none'),
    patch_size=-1,
    fc=True,
    temperature=0.1,
    pretrained_vq='/home/lr/models/vqvae/vqvae_youtube_d4_n8_c256_embc128.pth',
    pretrained=None
)
