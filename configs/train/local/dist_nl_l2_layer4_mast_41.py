...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=18, strides=(1, 2, 1, 2), out_indices=(2, 3), pool_type='mean', pretrained='/home/lr/models/ssl/image_based/mocov2plus_400ep_imagenet100_res18_pretrain_revise_keys.pth'),
