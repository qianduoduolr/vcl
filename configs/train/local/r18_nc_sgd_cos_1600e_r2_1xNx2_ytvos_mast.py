...
exp_name = 'r18_nc_sgd_cos_1600e_r2_1xNx2_ytvos_mast'
...
# dataset settings
train_dataset_type = 'VOS_youtube_dataset_rgb_V2'
...
train_pipeline = [
    dict(type='RandomResizedCrop', area_range=(0.2,1.0), aspect_ratio_range=(1.5, 2.0),same_across_clip=False,same_on_clip=False, keys='imgs_spa_aug'),
    dict(type='RandomResizedCrop', area_range=(0.8,1.0), aspect_ratio_range=(1.5, 2.0), same_across_clip=True,same_on_clip=True,),
