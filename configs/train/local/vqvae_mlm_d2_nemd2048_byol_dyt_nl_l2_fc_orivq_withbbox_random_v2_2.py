...
exp_name = 'vqvae_mlm_d2_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_2'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corr'

# model settings
model = dict(
    type='Vqvae_Tracker_V15',
    backbone=dict(type='ResNet18'),
    vqvae=dict(type='VQCL_v2', backbone=dict(type='ResNet18'),
