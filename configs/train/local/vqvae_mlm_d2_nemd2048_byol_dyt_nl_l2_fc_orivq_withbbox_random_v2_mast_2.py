...
exp_name = 'vqvae_mlm_d2_nemd2048_byol_dyt_nl_l2_fc_orivq_withbbox_random_v2_mast_2'
...
model = dict(
    ...
    vqvae=dict(type='VQCL_v2', backbone=dict(type='ResNet', depth=18, strides=(1, 1, 1, 1), out_indices=(3, )),
    ...
    pretrained_vq='/home/lr/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d2_nemd2048_contrastive_byol_commit1.0_v2_3/epoch_3200.pth',
)
...
data = dict(
    workers_per_gpu=2,
    train_dataloader=dict(samples_per_gpu=3, drop_last=True),  # 4 gpus
