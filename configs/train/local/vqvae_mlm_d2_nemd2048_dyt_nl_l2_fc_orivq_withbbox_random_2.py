...
exp_name = 'vqvae_mlm_d2_nemd2048_dyt_nl_l2_fc_orivq_withbbox_random_2'
...
train_pipeline = [
    ...
    dict(type='RGB2LAB', output_keys='jitter_imgs'),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='Normalize', **img_norm_cfg_lab, keys='jitter_imgs'),
