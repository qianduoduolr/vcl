...
exp_name = 'dist_nl_l2_layer4_mast_30'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Dist_Tracker_Two_Teacher',
    ...
    backbone_t2=dict(type='ResNet',depth=18, strides=(1, 2, 1, 2), out_indices=(2, ),pretrained='/home/lr/expdir/VCL/group_vqvae_tracker/train_vqvae_video_d4_nemd2048_contrastive_byol_commit1.0_v2_9/epoch_3200_revise_keys.pth', torchvision_pretrain=False),
    loss=dict(type='MSELoss',reduction='mean', loss_weight=1),
    loss_weight=dict(att1_loss=200, att2_loss=0),
    l1_loss=True,
    temperature=1.0,
    temperature_t=0.07,
    momentum=-1,
