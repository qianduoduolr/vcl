...
test_cfg = dict(
    backbone_=dict(
                    ...
                    pool_type=None, 
                    pretrained='/home/lr/expdir/VCL/group_stsl_former/mast_d4_l2_pyramid_dis_18/epoch_3200.pth', 
...
eval_config= dict(
                  ...
                  checkpoint_path='/home/lr/models/ssl/image_based/detco_200ep_AA.pth',
