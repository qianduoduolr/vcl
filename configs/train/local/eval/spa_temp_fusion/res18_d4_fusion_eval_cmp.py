...
model = dict(
    ...
    backbone=dict(type='ResNet',depth=50, strides=(1, 2, 1, 4), out_indices=(2,),  dilations=(1,1,2,4), \
        pretrained='/home/lr/models/ssl/image_based/cmp_res50_revise_keys.pth'),
    backbone_t=None,
...
test_cfg = dict(
    backbone_=dict(
                    dict(type='ResNet',depth=18, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/home/lr/expdir/VCL/group_stsl_former/mast_d4_l2_pyramid_dis_18/epoch_3200.pth', torchvision_pretrain=False)
                    ),
...
log_level = 'INFO'
work_dir = f'/home/lr/expdir/VCL/group_stsl/spa_temp_fusion/{exp_name}'
