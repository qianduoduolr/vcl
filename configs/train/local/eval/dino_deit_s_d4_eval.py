...
exp_name = 'dino_deit_s_d4_eval_3'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='VisionTransformer', arch='deit-s', img_size=(224, 224), patch_size=8, out_indices=(11,)),
    backbone_t=None,
...
test_cfg = dict(
    ...
    topk=5,
    temperature=0.1,
    model_cfg=dict(img_size=(224, 224),patch_size=8, arch='deit-s', out_indices=(11,)),
    neighbor_range=24,
    with_first=True,
...
train_pipeline = [
    ...
    dict(type='Resize', scale=(214, 120), keep_ratio=False),
...
eval_config= dict(
                  ...
                  torchvision_pretrained='/home/lr/models/ssl/image_based/dino_deitsmall8_pretrain.pth'
                )
