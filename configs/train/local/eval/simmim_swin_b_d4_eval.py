...
exp_name = 'simmim_swin_b_d4_eval'
docker_name = 'bit:5000/lirui_torch1.8_cuda11.1_corres'

# model settings
model = dict(
    type='Framework_V2',
    backbone=dict(type='SwinTransformer', pretrain_img_size=(480, 856), embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), strides=(4, 2, 1, 1), window_size=6, out_indices=(2,)),
    backbone_t=None,
...
test_cfg = dict(
    ...
    topk=10,
    temperature=0.07,
    model_cfg=dict(pretrain_img_size=(480, 856)),
    neighbor_range=24,
    with_first=True,
