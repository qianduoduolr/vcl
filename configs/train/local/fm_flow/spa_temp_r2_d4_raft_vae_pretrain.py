...
exp_name = 'spa_temp_r2_d4_raft_vae_pretrain'
...
model = dict(
            ...
            backbone=dict(type='ResNet',depth=18, strides=(1, 2, 2, 1), out_indices=(2, ), pool_type='none', pretrained='/home/lr/expdir/VCL/group_stsl_former/final_framework_v2_15/epoch_3200.pth', torchvision_pretrain=False, frozen_stages=4),
            cxt_backbone=dict(
                type='RAFTEncoder',
                in_channels=3,
                out_channels=256,
