...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 1, 1), out_indices=(3, ),pretrained='/home/lr/models/ssl/vcl/vfs_pretrain/r50_nc_sgd_cos_100e_r5_1xNx2_k400-d7ce3ad0.pth'),
...
evaluation = dict(output_dir=f'{work_dir}/eval_output_val', interval=1, by_epoch=True
                  )
