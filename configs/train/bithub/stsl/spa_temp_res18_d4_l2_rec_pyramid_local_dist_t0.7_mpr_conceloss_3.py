...
exp_name = 'spa_temp_res18_d4_l2_rec_pyramid_local_dist_t0.7_mpr_conceloss_3'
...
model = dict(
    ...
    backbone_t=dict(type='ResNet',depth=50, strides=(1, 2, 2, 4), out_indices=(2,), pool_type='none', dilations=(1,1,2,4), pretrained='/model/656146095/mp_res50_stage0/epoch_160.pth', torchvision_pretrain=False),
