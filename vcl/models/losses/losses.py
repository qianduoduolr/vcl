...
from vcl.models.builder import build_loss

from vcl.utils.util import tensor2img
...
class SequenceLoss(nn.Module):
    ...
    def __init__(self, gamma: float = 0.8, max_flow: float = 400., loss_fn=dict(type='SmoothL1Loss', reduction='none')):
        super().__init__()
        self.gamma = gamma
    ...
    @staticmethod
    def sequence_loss(preds, flow_gt, gamma, loss_fn, valid=None, max_flow=400):
    ...
    def forward(self,
        ...
        """
        return self.sequence_loss(flow_preds, flow_gt, self.gamma, self.loss_fn, valid,
                             self.max_flow)