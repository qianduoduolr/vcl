...
class VQVAE_3D(BaseModel):
    def __init__(self, 
        ...
        self.codebook = Codebook(n_embed, embedding_dim)
    ...
    def encode(self, x, include_embeddings=False):
        ...
        return vq_output['embeddings'], vq_output['encodings'], vq_output['commitment_loss']
    ...
    def forward_train(self, imgs):
        ...
        losses = {}
        losses['rec_loss'] = recon_loss
        losses['commit_loss'] = vq_output['commitment_loss']
