...
class SwinTransformerBlock(BaseModule):
    ...
    Args:
        ...
        norm_layer (BaseModule, optional): Normalization layer.  Default: nn.LayerNorm
    """
...
class BasicLayer(BaseModule):
    ...
    Args:
        ...
        norm_layer (BaseModule, optional): Normalization layer. Default: nn.LayerNorm
        downsample (BaseModule | None, optional): Downsample layer at the end of the layer. Default: None
...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer < self.num_layers - 1:
                downsample = PatchMerging(
                    ...
                    out_channels=2 * int(embed_dim * 2 ** i_layer),
                    stride=strides[i_layer + 1],
        ...
        if self.add_norm:
            ...
            layer = norm_layer(num_features[-1])
            layer_name = 'norm'
            self.add_module(layer_name, layer)
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            if i in self.out_indices:
                if self.add_norm:
                    # adapt to SimmMim and Moby pre-trained weights
