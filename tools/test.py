...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, help='checkpoint file', default='/home/lr/expdir/VCL/group_vqvae_tracker/vqvae_mlm_d4_nemd32_dyt_nl_l2_fc_orivq_motionwithbbox/epoch_800.pth')
    ...
    parser.add_argument(
        '--save-path',
        default='output/youtube/vis_vq_vqvae_mlm_d4_nemd32_dyt_nl_l2_fc_orivq_motionwithbbox',
        type=str,
