...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path', default='/home/lr/project/vcl/configs/train/local/stsl/spa_temp_res18_d4_l2_rec_pyramid_local_dist_t0.7_mp_conceloss_3.py')
