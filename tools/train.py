...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path', default='/home/lr/project/vcl/configs/train/local/train_vqvae_video_d2_nemd2048_contrastive_byol_commit1.0_v2_3.py')
